...
function peg$parse(input, options) {
  ...
  var peg$e0 = peg$literalExpectation("token", false);
  var peg$e1 = peg$literalExpectation("=", false);
  var peg$e2 = peg$literalExpectation(";", false);
  var peg$e3 = peg$literalExpectation("[", false);
  var peg$e4 = peg$literalExpectation("]", false);
  var peg$e5 = peg$literalExpectation("-", false);
  var peg$e6 = peg$otherExpectation("char");
  ...
  var peg$f2 = function(body) { return body };
  var peg$f3 = function(from) { return typeof to !== "undefined" ? { type: "CharRange", from, to } : { type: "Char", char: from }};
  ...
  var peg$f10 = function(id, properties) {
			return {
					type: "Output",
						properties
				}
		};
  var peg$f11 = function(name, value) { return {
			type: "Property",
				shorthand: !value,
				value: !value ? null : value[3],
				name
		}};
  var peg$f12 = function(id) { return { type: "Identifier", id }};
  var peg$f13 = function(value) { return { type:"String", value}};
  ...
  function peg$parseProgram() {
    ...
    s2 = peg$currPos;
    s3 = peg$parse_();
    s4 = peg$parseParseRule();
    if (s4 === peg$FAILED) {
      s4 = peg$parseTokenRule();
    }
    if (s4 !== peg$FAILED) {
      s5 = peg$parse_();
      s3 = [s3, s4, s5];
