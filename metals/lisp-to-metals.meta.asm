...
LA224:
    ...
    je terminate_program
    .loop:
    cmp dword [call_arg_count], 0
    je .loop_end
    dec dword [call_arg_count]
    error_store 'TAB'
    call vstack_clear
    call TAB
    call vstack_restore
...
LA236:
    ...
    error_store 'NESTED_FUNC_CALL'
    call vstack_clear
    call NESTED_FUNC_CALL
    call vstack_restore
    call error_clear
    cmp byte [eswitch], 1
    je LA239
